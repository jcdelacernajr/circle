	...
	protected void configure(HttpSecurity http) throws Exception {
		http
	       ...
	       .and()
		       ...
		       .antMatchers("/human-resources/*").hasAnyRole("HUMAN_RESOURCES","INVENTORY_MANAGEMENT","COMPANY_PROFILING")
		       .antMatchers("/human-resources/maintenance/**").hasAnyRole("SUPER_USER","ADMIN")
